...
public class ShowWaveScoreboard : MonoBehaviour
{
    public GameObject cellPrefab;
    void Start()
    {
        var data = DataManager.LoadPlayer("wave");
        if (data.Length == 0)
        {
            return;
        }
        ...
        foreach (var item in data)
        {
            ...
            obj.transform.GetChild(2).GetComponent<Text>().text = item.waveLevel.ToString();
        }
    }
}
